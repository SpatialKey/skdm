...
namespace tests
{
	...
	public class CommandLineOptionTest
	{
		...
		{
			CommandLineParser.OptionValue<String> option = new CommandLineParser.OptionValue<String>(new String[] {
				"test",
				"-t",
				"/test"
			});
		...
		{
			CommandLineParser.OptionValue<String> option = new CommandLineParser.OptionValue<String>(new String[] { "test" }, "desc", "VAL", "original value");
			Assert.IsFalse(option.Parse("/foo", new Queue<String>(new string[] { "/test", "third value" })));
			Assert.IsFalse(option.Parse("/test", new Queue<String>(new string[] { })));
		}
		...
		{
			CommandLineParser.OptionValue<String> option = new CommandLineParser.OptionValue<String>(new String[] { "test" }, "desc", "VAL", "original value");
			Assert.IsFalse(option.Parse("/foo", new Queue<String>(new string[] { "third value" })));
			Assert.IsTrue(option.Parse("/test", new Queue<String>(new string[] { "some value" })));
			Assert.AreEqual("some value", option.Value);
		}
		...
		public void TestOptionValueParseIntSuccess()
		{
			...
			Assert.IsTrue(option.Parse("/test", new Queue<String>(new string[] { "99" })));
		...
		public void TestOptionValueParseDoubleSuccess()
		{
			...
			Assert.IsTrue(option.Parse("/test", new Queue<String>(new string[] { "-123.456" })));
		...
		public void TestOptionValueParseTwiceAfterReset()
		{
			...
			Assert.IsTrue(option.Parse("/test", new Queue<String>(new string[] { "another value" })));
		...
		public void TestOptionListOneItem()
		{
			...
			Assert.IsTrue(option.Parse("/l", new Queue<String>(new string[] { "foo" })));
		...
		public void TestOptionListList()
		{
			CommandLineParser.OptionList<String> option = new CommandLineParser.OptionList<String>(new String[] { "l" });
			CollectionAssert.IsEmpty(option.Value);
			Assert.IsTrue(option.Parse("/l", new Queue<String>(new string[] { "foo, bar ,baz" })));
		...
		public void TestOptionListTwice()
		{
			...
			CollectionAssert.IsEmpty(option.Value);
			Assert.IsTrue(option.Parse("/l", new Queue<String>(new string[] { "foo" })));
			Assert.IsTrue(option.Parse("/l", new Queue<String>(new string[] { "bar ,baz" })));
			CollectionAssert.AreEqual(new String[] { "foo", "bar", "baz" }, option.Value);
		}
		...
		public void TestOptionCount()
		{
			...
			Assert.AreEqual(0, option.Value);
			Assert.IsFalse(option.IsMatched);
			Assert.IsTrue(option.Parse("/count", new Queue<String>(new string[] { })));
